...
function AdminUsersContent() {
  ...
  // State สำหรับเปิด-ปิดตาดูรหัสผ่านใน Modal แก้ไข
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-md w-full shadow-2xl border border-slate-100 animate-in zoom-in-95 duration-200 relative">
            ...
            <form onSubmit={handleOpenSaveConfirm} className="space-y-4">
              ...
              {/* ช่องรหัสผ่านใหม่ พร้อมปุ่มไอคอนรูปดวงตา */}
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-3.5 pr-10 py-2.5 bg-slate-50/50 border border-slate-200 rounded-xl text-xs md:text-sm font-bold text-slate-800 transition-all"
                  />
                  <button
                    type="button"
                    tabIndex={-1}
